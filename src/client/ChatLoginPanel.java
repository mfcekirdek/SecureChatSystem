...
public class ChatLoginPanel extends JPanel {
  ...
  void componentInit() throws Exception {
    ...
    _errorLabel = addLabel(gridBag, " ", SwingConstants.CENTER, 1, 9, 2, 1);
  ...
  JLabel addLabel(GridBagLayout gridBag, String labelStr, int align, int x, int y, int width,
      int height) {
    GridBagConstraints c = new GridBagConstraints();
  ...
  void addField(GridBagLayout gridBag, JTextField field, int x, int y, int width, int height) {
    GridBagConstraints c = new GridBagConstraints();
  ...
  void addCombobox(GridBagLayout gridBag, JComboBox<Integer> field, int x, int y, int width,
      int height) {
    GridBagConstraints c = new GridBagConstraints();
    field.setPreferredSize(new Dimension(96, field.getMinimumSize().height));
    c.gridx = x;
