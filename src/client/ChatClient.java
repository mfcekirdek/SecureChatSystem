            ...
            if (kp != null) {
                ...
                try {
                    ...
                    String encryptedClientDHPublic =
                            PublicKeyUtil.encrypt(String.valueOf(dhParameters.get("public")), serverCert.getPublicKey());
                    String encryptedClientDHGeneratorValue =
                            PublicKeyUtil.encrypt(String.valueOf(dhParameters.get("generatorValue")), serverCert.getPublicKey());
                    String encryptedClientDHPrimeValue =
                            PublicKeyUtil.encrypt(String.valueOf(dhParameters.get("primeValue")), serverCert.getPublicKey());
                    ...
                    if ((encryptedChatRoomKey = _in.readLine()) != null) {
                        ...
                        byte[] decryptedChatRoomKey =
                                SymmetricKeyUtil.decrypt(hashOfSharedKey16Bytes, zeroIV, Base64.decodeBase64(encryptedChatRoomKey));
